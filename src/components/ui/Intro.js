    ...
    <div className={`intro h-full bg-red text-cream flex flex-col justify-center text-center overflow-hidden ${className}`}>
      <div className="flex flex-col relative h-full justify-center items-center gap-6 pl-10 pr-10">
          ...
          <div className="absolute z-0 pointer-events-none  w-full h-full">
            <Image 
              className="absolute top-0 ml-[-1rem] mt-[1rem] sm:mt-[2rem] w-[10rem] sm:w-[14.125rem]" 
              src={sticker1} 
              width={226} 
              height={188} 
              alt=""
            />
            <Image 
              className="absolute top-0 right-0 mr-[-1rem] mt-[4rem] w-[6.1rem] sm:w-[8.625rem]" 
              src={sticker2} 
              width={138} 
              height={129} 
              alt=""
            />
            <Image 
              className="absolute bottom-0 ml-[-1rem] mb-[7rem] w-[5.7rem] sm:w-[8.0625rem]" 
              src={sticker3} 
              width={129} 
              height={127} 
              alt=""
            />
            <Image 
              className="absolute right-0 bottom-0 mr-[1rem] sm:mr-[3rem] mb-[1rem] sm:mb-[2rem] w-[8rem] sm:w-[11.125rem]" 
              src={sticker4} 
              width={178} 
              height={132} 
              alt=""
